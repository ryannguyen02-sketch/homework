...
### step 1: Define the regex patterns
error_count = re.compile(r"\bERROR\b.*\bE\d{4}\b")
warn_count  = re.compile(r"\bWARN\b.*\[[a-z]+\]")
...
### step 3: Loop through the lines with if-elif-else
for line in lines:
...
### step 2: Write a function to check password
