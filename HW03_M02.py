...
#### Part I: Employee Performance Report (Control flow exercises)
### Given a list of employees (dictionary containing employee's name, salary, department, and performance score),
# Your task is to:
...
for e in employees:
    ...
    print(e["name"], "average score:", round(avg_score, 2))
...
### Part C. Find the employee with the highest salary in the "Engineering" department
print("\nPart C:")
highest_salary = 0
highest_employee = ""
